...
df_efforts_voiles_rupt = get_efforts_voiles(page_coord_voiles=pages_rupteur['Coordonnées_voiles'], 
...
df_efforts_voiles_rupt = get_efforts_voiles(page_coord_voiles=pages_base['Coordonnées_voiles'], 
